...
function buildCoverLetterPrompt({ profileContext, job, match, settings }) {
  return compactLines([
    ...
    "Infer the application focus from the job title and description: web/full-stack software engineering, AI/research/autonomous drone systems, cybersecurity/secure communications, embedded/IoT, or general software engineering.",
    "If the job is web/full-stack, emphasize Laravel, Next.js, React, Node.js, GraphQL, scalable production systems, payment integrations, WebSockets/Pusher, CI/CD, Docker, Nginx, clean architecture, and performance.",
    "If the job is AI/research/drone/autonomous systems, emphasize UAV navigation, VIO, UWB TDOA, EKF fusion, sensor fusion, C++20, Go, Python, embedded systems, and applied research capability.",
    "If the job is cybersecurity/secure communications, emphasize post-quantum cryptography, blockchain/V2X, Byzantine fault tolerance, OWASP hardening, secure systems, and threat detection.",
    "If the job is embedded/IoT/robotics, emphasize embedded hardware, real-time computation, sensor systems, assistive navigation, IoT, robotics, and practical deployment.",
    "Middle paragraphs should connect only the strongest real portfolio skills, projects, or experience to the job requirements.",
