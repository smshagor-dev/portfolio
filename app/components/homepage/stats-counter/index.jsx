      ...
      <div className="rounded-[1.8rem] border border-[#2b3046] bg-[linear-gradient(180deg,rgba(18,22,36,0.96),rgba(12,16,30,0.96))] p-4 shadow-[0_24px_55px_rgba(0,0,0,0.18)] backdrop-blur-xl sm:p-6 lg:p-8">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {statsItems.map((item, index) => {
            ...
            return (
              <div
                className="rounded-2xl border border-[#273056] bg-[linear-gradient(180deg,rgba(20,24,42,0.94),rgba(12,16,31,0.94))] p-5 transition hover:border-[#7a61ff]"
                key={`${item?.label || "counter"}-${index}`}
              >
                <div className="mb-4 flex items-center justify-between gap-3">
                  <span className="inline-flex rounded-full border border-[#39457b] bg-[#131a33] px-3 py-1 text-[10px] font-medium uppercase tracking-[0.28em] text-[#f0d7a1]">
                ...
                <p className="text-3xl font-semibold text-white sm:text-4xl">{item?.count}</p>
